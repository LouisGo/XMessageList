...
export class ApplicationMessageListManager<Row, Conversation = MessageListConversationId>
  ...
  getController(id: MessageListConversationId): MessageListController<Row> {
    ...
    const conversation = this.resolveConversation(id)
    const adapter = this.options.resolveAdapter(conversation)
  ...
  private resolveConversation(id: MessageListConversationId): Conversation {
    return this.options.resolveConversation
      ? this.options.resolveConversation(id)
      : id as Conversation
  }
