...
Bootstrap、bottom lock、React projection、scroll motion、diagnostics 等细节已经并入新的 physical segment 文档体系：
...
后续重构不得回到连续 DataWindow scrollHeight 模型。保留本文件只是为了避免旧链接失效。
