...
| [../viewport-runtime/runtime-next-architecture.md](../viewport-runtime/runtime-next-architecture.md) | 需要判断旧 runtime 与 runtime-next 边界、几何唯一 owner 和 review checklist 时 | runtime-next ownership |
...
Message Identity Anchor
  ...
  -> Renderer Viewport Runtime
     -> runtime-next / PhysicalSegment / CustomScrollbar / SegmentShift
